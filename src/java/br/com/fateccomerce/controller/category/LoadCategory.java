...
public class LoadCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("category", dao.findById(Integer.parseInt(request.getParameter("id"))));
        }  catch (Exception e) {
            System.out.println("Problema ao selecionar categoria para ser alterada: " + e.getMessage());
            e.printStackTrace();
        } finally{
